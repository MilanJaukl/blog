<?php include_once "includes/header.php"; ?>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-3 mb-4" onclick="location.href='post.php';">
                            <div class="card shadow border-start-primary py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Posts</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span><?php echo count(Post::getPublishedPosts())?></span></div>
                                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4" onclick="location.href='user.php';">
                            <div class="card shadow border-start-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Users</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span><?php echo count(User::getAll());?></span></div>
                                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4" onclick="location.href='category.php';">
                            <div class="card shadow border-start-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Categories</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span><?php echo count(Category::getAll());?></span></div>
                                        </div>
                                        <div class="col-auto"><i class="fas fa-dollar-sign fa-2x text-gray-300"></i></div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4" onclick="location.href='comment.php';">
                            <div class="card shadow border-start-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Comments</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span><?php echo count(Comment::getAll());?></span></div>
                                        </div>
                                        <div class="col-auto"><i class="fas fa-dollar-sign fa-2x text-gray-300"></i></div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-xl-8">
                            <div class="card shadow mb-4">
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <div style="width: 120px;" id="columnchart_material"></div>
                                    </div>
                                    <div class="col-3">
                                        <div style="width: 120px;"  id="columnchart_material2"></div>
                                    </div>
                                    <div class="col-3">
                                        <div style="width: 120px;"  id="columnchart_material3"></div>
                                    </div>
                                    <div class="col-3">
                                        <div style="width: 120px;"  id="columnchart_material4"></div>
                                    </div>
                                </div>
    ...
    google.charts.load('current', {'packages':['bar']});
        ...
        function drawChart() {
            ...
            ['Posts','Published', 'Not Publsihed', { role: 'annotation' } ],
            ['2010', <?php echo count(Post::getPublishedPosts())?>, <?php echo 20 ?>, '']
            ]);
            var options = {
                width: 120,
                height: 350,
...
google.charts.load('current', {'packages':['bar']});
    ...
    function drawChart() {
        var data = google.visualization.arrayToDataTable([
        ['Data','Readers', 'Authors', 'Admins', { role: 'annotation' } ],
        ['Users', <?php echo count(User::getArrayOfUserTypes()['users'])?>, <?php echo count(User::getArrayOfUserTypes()['authors']) ?>, <?php echo count(User::getArrayOfUserTypes()['admins']) ?>, '']
        ]);
        var options = {
            width: 120,
            height: 350,
...
google.charts.load('current', {'packages':['bar']});
    ...
    function drawChart() {
        var data = google.visualization.arrayToDataTable([
        ['Categories','Published', 'Not Publsihed', { role: 'annotation' } ],
        ['2010', <?php echo count(Post::getPublishedPosts())?>, <?php echo (count(Post::getAll())-count(Post::getPublishedPosts())) ?>, '']
        ]);
        var options = {
            width: 120,
            height: 350,
...
google.charts.load('current', {'packages':['bar']});
    ...
    function drawChart() {
        var data = google.visualization.arrayToDataTable([
        ['Comments','Published', 'Not Publsihed', { role: 'annotation' } ],
        ['2010', <?php echo count(Post::getPublishedPosts())?>, <?php echo (count(Post::getAll())-count(Post::getPublishedPosts())) ?>, '']
        ]);
        var options = {
            width: 120,
